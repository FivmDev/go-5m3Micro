...
const (
	User_GetUserListInfo_FullMethodName = "/User/GetUserListInfo"
...
type UserClient interface {
	GetUserListInfo(ctx context.Context, in *PackageReq, opts ...grpc.CallOption) (*UserListInfo, error)
	GetUserByMobile(ctx context.Context, in *MobileReq, opts ...grpc.CallOption) (*UserInfo, error)
	...
	CheckPassword(ctx context.Context, in *CheckPasswordInfo, opts ...grpc.CallOption) (*CheckResult, error)
}
...
func (c *userClient) GetUserListInfo(ctx context.Context, in *PackageReq, opts ...grpc.CallOption) (*UserListInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserListInfo)
	err := c.cc.Invoke(ctx, User_GetUserListInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetUserByMobile(ctx context.Context, in *MobileReq, opts ...grpc.CallOption) (*UserInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserInfo)
...
func (c *userClient) GetUserById(ctx context.Context, in *IdReq, opts ...grpc.CallOption) (*UserInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserInfo)
...
func (c *userClient) CheckPassword(ctx context.Context, in *CheckPasswordInfo, opts ...grpc.CallOption) (*CheckResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckResult)
...
func (UnimplementedUserServer) GetUserListInfo(context.Context, *PackageReq) (*UserListInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserListInfo not implemented")
}
func (UnimplementedUserServer) GetUserByMobile(context.Context, *MobileReq) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserByMobile not implemented")
}
func (UnimplementedUserServer) GetUserById(context.Context, *IdReq) (*UserInfo, error) {
...
func (UnimplementedUserServer) CheckPassword(context.Context, *CheckPasswordInfo) (*CheckResult, error) {
...
func _User_GetUserListInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PackageReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetUserListInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetUserListInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserListInfo(ctx, req.(*PackageReq))
	}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetUserListInfo",
			Handler:    _User_GetUserListInfo_Handler,
		},
		{
